...
variable "db_username" {
  type        = string
  default     = ""
  description = "Master username (letters, digits, underscores; must start with a letter; max 32 chars). Empty uses qoveryadmin, the login the native managed databases used."
